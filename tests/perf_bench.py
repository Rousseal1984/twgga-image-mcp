...
串行跑 gpt-image-2 在不同 size 下的 image_generate，
...
IMAGE2_FULL: list[tuple[str, str, str]] = [
    ...
    ("image2", "gpt-image-2", "2048x2048"),
    ("image2", "gpt-image-2", "2048x1152"),
    ("image2", "gpt-image-2", "3840x2160"),
]
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(
        description="TWGGA MCP 性能基线测试（仅 gpt-image-2）"
    )
