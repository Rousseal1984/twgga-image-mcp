"""Offline Twgga Images API and forward-proxy fixture.
...
class MockTwggaApi:
    ...
    def __enter__(self) -> "MockTwggaApi":
    ...
    def env(self) -> dict[str, str]:
        return {
            "TWGGA_BASEURL": self.base_url,
            "TWGGA_API_KEY": self.expected_key,
            "TWGGA_USE_SHELL_PROXY": "1",
