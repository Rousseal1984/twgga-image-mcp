...
@pytest.mark.parametrize("model", ["gpt-image-2"])
...
@pytest.mark.parametrize(
    ...
    [
        # 单线路：无论请求什么尺寸，解析出的模型都是同一个。
        (None, "1024x1024", "gpt-image-2"),
        ("gpt-image-2", "1536x1024", "gpt-image-2"),
        (None, "2048x1152", "gpt-image-2"),
        ("gpt-image-2", "2048x2048", "gpt-image-2"),
        ("gpt-image-2", "3840x2160", "gpt-image-2"),
    ],
)
